...
export default function ClassesEdit() {
    const { classes } = usePage<ClassesEditPageProps>().props;

    const { data, setData, errors, put } = useForm({
        name: classes.name || "",
        mondaystart: classes.mondaystart || "",
        mondayend: classes.mondayend || "",
        tuesdaystart: classes.tuesdaystart || "",
        tuesdayend: classes.tuesdayend || "",
        wednesdaystart: classes.wednesdaystart || "",
        wednesdayend: classes.wednesdayend || "",
        thursdaystart: classes.thursdaystart || "",
        thursdayend: classes.thursdayend || "",
        fridaystart: classes.fridaystart || "",
        fridayend: classes.fridayend || "",
        saturdaystart: classes.saturdaystart || "",
        saturdayend: classes.saturdayend || ""
    });
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <form onSubmit={submit}>            
                    <Card className="w-[450px] overflow-hidden">
                        <CardHeader>
                            <CardTitle>Edit a class</CardTitle>
